        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full sm:w-1/2 lg:w-1/4 px-4 mb-12 lg:mb-0">
            <div className="flex flex-col h-full">
              ...
              <h5 className="text-2xl font-medium text-white mt-6 mb-3">EV charging </h5>
              <p className="text-white opacity-80 mb-6">EVs use electricity as a power source, which can be generated from renewable energy sources. Our solutions help reducing greenhouse gas emissions in the transportation sector.</p>
          ...
          <div className="w-full sm:w-1/2 lg:w-1/4 px-4 mb-12 lg:mb-0">
            <div className="flex flex-col h-full">
              ...
              <h5 className="text-2xl font-medium text-white mt-6 mb-3">Solar Energy</h5>
              <p className="text-white opacity-80 mb-6">Solar panels convert sunlight into electricity. Photovoltaic (PV) cells on these panels capture the energy from the sun and convert it into electrical power.</p>
              <a href="#" className="inline-block mt-auto text-lg font-medium text-white hover:text-lime-500">Read more</a>
            </div>
          </div>
          <div className="w-full sm:w-1/2 lg:w-1/4 px-4 mb-12 sm:mb-0">
            <div className="flex flex-col h-full">
              ...
              <h5 className="text-2xl font-medium text-white mt-6 mb-3">Wind Energy</h5>
              <p className="text-white opacity-80 mb-6">Wind turbines harness the kinetic energy of the wind to generate electricity. Wind farms with multiple turbines are commonly used to produce large amounts of clean energy.</p>
              <a href="#" className="inline-block mt-auto text-lg font-medium text-white hover:text-lime-500">Read more</a>
            </div>
          </div>
          <div className="w-full sm:w-1/2 lg:w-1/4 px-4">
            <div className="flex flex-col h-full">
              ...
              <h5 className="text-2xl font-medium text-white mt-6 mb-3">Hydropower</h5>
              <p className="text-white opacity-80 mb-6">This technology uses the energy from flowing water, such as rivers and dams, to turn turbines and generate electricity. It's one of the oldest forms of renewable energy.</p>
              <a href="#" className="inline-block mt-auto text-lg font-medium text-white hover:text-lime-500">Read more</a>
            </div>
          </div>
        </div>
